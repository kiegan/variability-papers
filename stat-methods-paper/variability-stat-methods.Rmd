...
We consider complex data structures with much higher dimensionality, and a structure which inherently differs from those of the responses considered by \cite{Sweeney} and \cite{Peruchi}. As such, we must consider a different modeling approach.   
